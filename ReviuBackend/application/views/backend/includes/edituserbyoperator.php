	    <section class="panel">
			...
			<div class="panel-body">
			  <form class="form-horizontal tasi-form" method="post" action="<?php echo site_url('site/edituserbyoperatorsubmit');?>">
				<input type="hidden" id="normal-field" class="form-control" name="id" value="<?php echo set_value('id',$before->id);?>" style="display:none;">
				<input type="hidden" id="normal-field" class="form-control" name="email" value="<?php echo set_value('id',$before->email);?>" style="display:none;">
				...
				<div class=" form-group">
				  ...
				  <a href="<?php echo site_url('site/edituserbyoperator'); ?>" class="btn btn-secondary">Cancel</a>
				</div>
				</div>
			  </form>
			</div>
